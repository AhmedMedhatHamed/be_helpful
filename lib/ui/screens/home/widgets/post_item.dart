                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Icon(Icons.watch_later_outlined , color: AppColors.grey,)
                          ],
                        ),
                        Text(
                          postDM.location??"",
                        ...
                        //     ),
                        //     //const Icon(Icons.category_outlined,color: AppColors.grey,)
                        //   ],
                        // ),
                      ],
                    ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        margin: const EdgeInsets.only(left: 20.0 ,bottom: 10.0,top: 10.0),
                      ),
                    ],
                  ),
                ],

...
class FurnitureDecorationScreen extends StatelessWidget {
  const FurnitureDecorationScreen({super.key});

  static const String routeName = 'FurnitureDecorationScreen';
  @override
